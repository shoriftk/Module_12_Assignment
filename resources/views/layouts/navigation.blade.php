        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('bus.trip')" :active="request()->routeIs('bus.trip')">
                        {{ __('Trip') }}
                    </x-nav-link>
                    <x-nav-link :href="route('bus.search')" :active="request()->routeIs('bus.search')">
                        {{ __('Find Ticket') }}
                    </x-nav-link>
                    <x-nav-link :href="route('bus.purchased-ticket')" :active="request()->routeIs('bus.purchased-ticket')">
                        {{ __('Purchased Ticket') }}
                    </x-nav-link>
                    <x-nav-link :href="route('bus.all-trip')" :active="request()->routeIs('bus.all-trip')">
                        {{ __('All Trips') }}
                    </x-nav-link>
                </div>
            </div>
